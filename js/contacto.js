...
// Crea y retorna un new Object() con la
// estructura de un mensaje de contacto
...
function crearMensaje(nombre, email, pais, mensaje) {
    ...
    nuevoMensaje.pais     = pais;
    nuevoMensaje.mensaje  = mensaje;
    nuevoMensaje.fecha    = new Date().toLocaleDateString('es-SV');
    return nuevoMensaje;
}
    ...
    if (form) {
        form.addEventListener('submit', function (e) {
            ...
            if (idEditando !== null) {
                ...
                // --- CREAR nuevo object con new Object() ---
                const nuevoMensaje = crearMensaje(nombre, email, pais, mensaje);
